...
class DT_Metrics_Mapbox_Trainings_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'mapbox_trainings_maps'; // lowercase
    public $js_object_name = 'wp_js_object'; // This object will be loaded into the metrics.js file by the wp_localize_script.
    public $js_file_name = '/dt-metrics/common/maps_library.js'; // should be full file name plus extension
    public $permissions = [ 'view_any_trainings', 'view_project_metrics' ];
    public $namespace = 'dt-metrics/trainings';
    public $base_filter = [];
