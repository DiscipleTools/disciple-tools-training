...
class DT_Metrics_Mapbox_Personal_Trainings_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'personal_trainings'; // lowercase
    ...
    public function __construct() {
        ...
        $this->title = __( 'Trainings Maps', 'disciple-tools-training' );
...
new DT_Metrics_Mapbox_Personal_Trainings_Maps();
